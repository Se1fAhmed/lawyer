...
$table = $_SESSION['type'];
$select = "SELECT * FROM  $table  where id = $adminid";
...
if (isset($_POST['update'])) {
  ...
  $location =  "./$table/upload/";
  move_uploaded_file($image_tmp, $location . $image_name);

  $insert = "UPDATE $table SET name= '$name', email ='$email' ,password= '$password',image= '$image_name' where id = $adminid  ";
  $q = mysqli_query($conn, $insert);
  testMassage($q, "Update $table");
}
?>
      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            ...
            <img src="./<?= $_SESSION['type'] ?>/upload/<?php echo $row['image'] ?>" alt="Profile" class="rounded-circle">
                ...
                <form method="POST" enctype="multipart/form-data">
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <img src="./<?= $_SESSION['type'] ?>/upload/<?php echo $row['image'] ?>" alt="Profile">
